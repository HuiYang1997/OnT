...
from ont.hyperbolic import get_circum_poincareball

logger = logging.getLogger(__name__)


class HierarchyTransformer(SentenceTransformer):
    r"""Hierarchy Transformer encoder (HiT), extending from SentenceTransformer.
    ...
    def from_pretrained(
        ...
        try:
            ...
            # Load from huggingface transformers library (suppress noisy LOAD REPORT)
