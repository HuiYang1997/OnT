...
from transformers import HierarchyTransformer
...
class OntologyTransformer(nn.Module):
    ...
    def encode_concept(self, concept_sentences):
        concept_embed = self.hit_model.encode(concept_sentences)
    ...
    def load(input_path: str):
        ...
        # Create OntologyTransformer instance with loaded configuration
        onT = OntologyTransformer(base_model, role_emd_mode, role_model_mode)
